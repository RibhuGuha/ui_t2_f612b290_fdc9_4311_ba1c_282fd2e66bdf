...
const Component = (props) => {
    ...
    const OnSubmit = async () => {
        ...
        rslt = await Support.AddOrUpdateProperty(property, dropDownOptions, ['MainImage']);
        if (rslt.status) {
            propertyId = rslt.id;
        } else { return; }
